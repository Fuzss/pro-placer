package fuzs.proplacer.common.config;
...
public class ClientConfig implements ConfigCore {
    ...
    @Config(name = "normal_placement_blocks", description = {
            "Blocks that are excluded from the fast placement mechanic.", ConfigDataSet.CONFIG_DESCRIPTION
    })
    List<String> normalPlacementRaw = KeyedValueProvider.asString(Registries.BLOCK, Blocks.SCAFFOLDING);
